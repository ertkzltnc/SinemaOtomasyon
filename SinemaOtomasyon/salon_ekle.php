<?php
	...
	if($_POST) {
		...
		$vv = rtrim($vv,", ");
		if(empty($uyari)) {	
			$ekle = mysql_query("insert into salonlar set $vv ");
			...
			<div class="row main">
				<div class="panel-heading">
	               <div class="panel-title text-center">
	               		<h1 class="title"><?=$sinema["adi"]?> | Salon Ekle</h1>
	               		<hr />
	               	</div>
	            </div> 
				...
				<div >
					<form class="form-horizontal" method="post" action="#">
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<input type="text" class="form-control" name="salon_adi"   />
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<input type="text" class="form-control" name="ses_sistemi"   />
